...
const gopay = '082360929594';
const pulsa = '082360929594';
const dana = '082360929594';
const BotName = 'ChocoBot'; 
const instagram = 'http://www.instagram.com/im.chocolates'; 
const whatsapp = 'https://chat.whatsapp.com/HMdJ6euQDQlIQhXDVfHgXX'; 
const aktif = '00:00 - 23:59';
...
const vcard2 = 'BEGIN:VCARD\n'
            ...
            + 'FN:Reza\n' // Nama kamu
            + 'ORG:Owner ChocoBot;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6288269147510:+62 882-6914-7510\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Choco Bot')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : ''
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@im.chocolates`)
})
...
if (text.includes('.owner')){
conn.sendMessage(id, {displayname: "Jeff", vcard2: vcard2}, MessageType.contact, {quoted: m})
}
if (text.includes('.owner')){
conn.sendMessage(id, {displayname: "Jeff", vcard3: vcard3}, MessageType.contact, {quoted: m})
}
if (text.includes('.owner')){
conn.sendMessage(id, {displayname: "Jeff", vcard4: vcard4}, MessageType.contact, {quoted: m})
}
...
conn.sendMessage(id, 'How to install whatsapp bot on android\n*Tutorial* : https://github.com/RizkyAfandi205/BotV3',MessageType.text, { quoted: m } );
}
 //intro grup
